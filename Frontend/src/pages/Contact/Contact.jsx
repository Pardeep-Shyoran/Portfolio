...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Pardeep Shyoran || Portfolio</title>
        <meta
          name="description"
          content="Reach out to Pardeep Shyoran for collaborations, freelance work, or tech discussions. Let’s build something impactful."
        />
        <meta
          name="keywords"
          ...
          <div className={styles.contactInfo}>
            <div className={styles.contactInfoItem}>
              ...
              <div className={styles.contactInfoText}>
                <div className={styles.contactInfoHeadLink}>
                  <strong>Email:</strong>
                </div>
                <div className={styles.contactInfoLink}>
                  pardeepshyoran@outlook.com
                </div>
              </div>
            </div>
            <div className={styles.contactInfoItem}>
            ...
            <div className={styles.contactInfoItem}>
              ...
              <div className={styles.contactInfoText}>
                ...
                <div className={styles.contactInfoLink}>
                  https://www.linkedin.com/in/pardeepshyoran/
                </div>
              </div>
            </div>
          </div>
